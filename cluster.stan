...
// ./cluster511 sample algorithm=hmc engine=nuts max_depth=17 adapt delta=0.999 num_warmup=3000 num_samples=2000 num_chains=4 init=data/_iron_cluster_init.json data file=data/_iron_cluster.json output file=output/cluster_511.csv
