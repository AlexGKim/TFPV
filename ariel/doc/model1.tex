...
\begin{description}
    ...
    \item[$\Xi$:] Distribution function of $y_{\text{TF}}$.
\end{description}
...
We construct a sample by imposing an upper limit on the measured value $\hat y$ to remove dwarf-galaxies that do not follow the Tully-Fisher relation,
and a two-sided parallel half-plane cut in the measured $(\hat x,\hat y)$-plane to remove extreme outliers that occur in the DESI data.

We also impose a lower limit on the measured value $\hat y$ in order to reduce sensitivity on the model choice of the distribution of $y_\text{TF}$. 
