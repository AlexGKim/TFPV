...
To handle potential catastrophic outliers on both sides of the TF relation while enforcing a finite observed range in $\hat y$, we construct a sample by imposing (i) \emph{lower and upper limits} on the measured value $\hat y$ and (ii) a \emph{two-sided parallel half-plane cut} in the measured $(\hat x,\hat y)$-plane. The selection domain is
\begin{equation}
\mathcal S_i:\qquad
