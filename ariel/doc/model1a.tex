...
\end{align}
bu definition, where $\Phi_2$ is the bivariate standard normal cumulative distribution function.
...
a maximum $\hat{y}_{\max}$
  the input $s$ and $c$ are recovered to TBD %incredible precision,
 % and the intrinsic dispersions to 1$\sigma$.
