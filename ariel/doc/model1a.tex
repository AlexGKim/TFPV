...
\begin{equation}
\alpha \;=\; \frac{b - \bigl(\mu_{2,i}-a\,\mu_{1,i}\bigr)}{\sqrt{\sigma_{2,i}^2 + a^2\,\sigma_{1,i}^2}}
\;=\;
\frac{b - \left(y_{\mathrm{TF},i}-a\,\frac{y_{\mathrm{TF},i}-c}{s}\right)}{\sqrt{\sigma_{2,i}^2 + a^2\,\sigma_{1,i}^2}}
\end{equation}

\begin{equation}
\beta \;=\; \frac{\hat y_{\max,i} - \mu_{2,i}}{\sigma_{2,i}}
\;=\;
\frac{\hat y_{\max,i} - y_{\mathrm{TF},i}}{\sigma_{2,i}}
\end{equation}
